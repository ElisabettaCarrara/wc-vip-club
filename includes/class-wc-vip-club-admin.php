<?php
/**
 * WC VIP Club Admin handler.
 *
 * Handles the VIP Club settings tab in WooCommerce admin.
 *
 * @package WC_VIP_Club
 */
...
final class WC_VIP_Club_Admin {
	...
	private function register_hooks(): void {
		// Add VIP Club tab to WooCommerce settings.
		add_filter(
		...
		// Render settings fields for the tab.
		add_action(
		...
		// Sanitize role name, slug, and threshold fields.
		add_filter(
	...
	public function add_settings_tab( array $tabs ): array {
		$tabs['wc_vip_club'] = esc_html__( 'VIP Club', 'wc-vip-club' );
		return $tabs;
	}

	/**
	 * Render VIP Club settings fields.
	 *
	 * @return void
	 */
